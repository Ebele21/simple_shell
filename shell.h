...
/**
 ***** struct liststr - It is singly linked list
 ...
 ***** @arg: It is a string generated from getline containing arguements
 ...
 ***** @env: It is a linked list local copy of environ
 ***** @environ: It is a custom modified copy of environ from LL env
 ***** @history: It is the history node
 ***** @alias: It is the alias node
 ***** @env_changed: It is the on if environ was changed
 ***** @status: It is the return status of the last exec'd command
 ***** @cmd_buf: It is the address of pointer to cmd_buf, on if chaining
...
/**
 *** struct builtin - It contains a builtin string and it's related function**
